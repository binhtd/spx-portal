  ...
  csscody = {
      ...
      if(this.options.display == 0 && option != 0 || option == 1) {
        ...
        if(this.i==1) {
          ...
          $('#BoxOverlay').fadeOut(this.options.closeDuration, $.bind(this, function(){
            $('#BoxOverlay').hide();
			//start comment by binhtd
            //if (!$.support.maxHeight) { //IE6
            //  $('embed, object, select').css({ 'visibility' : 'hidden' });
            //}
			//end comment by binhtd
    ...
    messageBox: function(type, message, properties, input) {
        ...
        else if(type == 'confirm')
        {
            ...
            $('#BoxConfirmBtnOk').val(properties.textBoxBtnOk).css({'width':150});
        ...
        else if(type == 'prompt')
        {
            ...
            $('#BoxPromptBtnOk').val(properties.textBoxBtnOk).css({'width':150});
