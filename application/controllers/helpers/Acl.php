...
class Zend_Controller_Action_Helper_Acl extends Zend_Controller_Action_Helper_Abstract
{
	...
	private function setRoles()
	{
		...
		$this->acl->addRole(new Zend_Acl_Role('translator', 'client'));
		$this->acl->addRole(new Zend_Acl_Role('jonckerspm'), 'translator');
	...
	private function setResources()
	{
		...
		$this->acl->add(new Zend_Acl_Resource('export'));
	}
	...
	private function setPrivilages()
	{
		...
		$this->acl->deny('translator','ho','add');
	}	
