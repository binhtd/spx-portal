...
class LanguageController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
		...
		$language->LanguageIsShowInTranslatorList = $form->getValue("LanguageIsShowInTranslatorList") == "N" ? "N" : ($form->getValue("LanguageIsShowInTranslatorList") == "Y" ? "Y" : "N");
    ...
    public function editAction()
    {
		...
		if(!$this->getRequest()->isPost()){
			$form->populate(array("LanguageID" => $language->LanguageID, "LanguageName" => $language->LanguageName, "LanguageIsActive" => $language->LanguageIsActive, "LanguageIsShowInSourceList" =>$language->LanguageIsShowInSourceList, "LanguageIsShowInTargetList" => $language->LanguageIsShowInTargetList,"LanguageIsShowInTranslatorList" => $language->LanguageIsShowInTranslatorList));
