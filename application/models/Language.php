...
class Application_Model_Language
{
	...
	private $_languageIsShowInTranslatorList;
	...
	public function setLanguageIsShowInTranslatorList($languageIsShowInTranslatorList){
		$this->_languageIsShowInTranslatorList = (string)$languageIsShowInTranslatorList;
		return $this;
	}
	
	public function getLanguageIsShowInTranslatorList(){
		return $this->_languageIsShowInTranslatorList;
	}
