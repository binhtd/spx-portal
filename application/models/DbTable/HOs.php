...
class Application_Model_DbTable_HOs extends Zend_Db_Table_Abstract
{
	...
	protected $_dependentTables = array('Application_Model_DbTable_HandOffTargetLanguages', 'Application_Model_DbTable_HandoffTargetLanguagesHistory', 'Application_Model_DbTable_TranslationForTranslators');
	protected $_referenceMap = array(
		...
		'ho_language' => array(
            'columns'           => array('HandOffSourceLanguageID'),
